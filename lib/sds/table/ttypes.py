...
class TableSchema(object):
  ...
  def write(self, oprot):
    ...
    if self.secondaryIndexes is not None:
      ...
      for kiter133,viter134 in list(self.secondaryIndexes.items()):
    ...
    if self.attributes is not None:
      ...
      for kiter135,viter136 in list(self.attributes.items()):
    ...
    if self.streams is not None:
      ...
      for kiter137,viter138 in list(self.streams.items()):
    ...
    if self.globalSecondaryIndexes is not None:
      ...
      for kiter139,viter140 in list(self.globalSecondaryIndexes.items()):
...
class TableMetadata(object):
  ...
  def write(self, oprot):
    ...
    if self.appAcl is not None:
      ...
      for kiter167,viter168 in list(self.appAcl.items()):
    ...
    if self.acl is not None:
      ...
      for kiter170,viter171 in list(self.acl.items()):
...
class TableSplit(object):
  ...
  def write(self, oprot):
    ...
    if self.startKey is not None:
      ...
      for kiter187,viter188 in list(self.startKey.items()):
    ...
    if self.stopKey is not None:
      ...
      for kiter189,viter190 in list(self.stopKey.items()):
...
class GetRequest(object):
  ...
  def write(self, oprot):
    ...
    if self.keys is not None:
      ...
      for kiter204,viter205 in list(self.keys.items()):
...
class GetResult(object):
  ...
  def write(self, oprot):
    ...
    if self.item is not None:
      ...
      for kiter214,viter215 in list(self.item.items()):
...
class PutRequest(object):
  ...
  def write(self, oprot):
    ...
    if self.record is not None:
      ...
      for kiter223,viter224 in list(self.record.items()):
...
class IncrementRequest(object):
  ...
  def write(self, oprot):
    ...
    if self.keys is not None:
      oprot.writeFieldBegin('keys', TType.MAP, 2)
      oprot.writeMapBegin(TType.STRING, TType.STRUCT, len(self.keys))
      for kiter239,viter240 in list(self.keys.items()):
    ...
    if self.amounts is not None:
      ...
      for kiter241,viter242 in list(self.amounts.items()):
...
class IncrementResult(object):
  ...
  def write(self, oprot):
    ...
    if self.amounts is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.STRUCT, len(self.amounts))
      for kiter250,viter251 in list(self.amounts.items()):
...
class RemoveRequest(object):
  ...
  def write(self, oprot):
    ...
    if self.keys is not None:
      oprot.writeFieldBegin('keys', TType.MAP, 2)
      oprot.writeMapBegin(TType.STRING, TType.STRUCT, len(self.keys))
      for kiter265,viter266 in list(self.keys.items()):
...
class ScanRequest(object):
  ...
  def write(self, oprot):
    ...
    if self.startKey is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.STRUCT, len(self.startKey))
      for kiter288,viter289 in list(self.startKey.items()):
    ...
    if self.stopKey is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.STRUCT, len(self.stopKey))
      for kiter290,viter291 in list(self.stopKey.items()):
...
class ScanResult(object):
  ...
  def write(self, oprot):
    ...
    if self.nextStartKey is not None:
      ...
      for kiter313,viter314 in list(self.nextStartKey.items()):
    ...
    if self.records is not None:
      ...
      for iter315 in self.records:
        ...
        for kiter316,viter317 in list(iter315.items()):
...
class InternalMutationLogEntry(object):
  ...
  def write(self, oprot):
    ...
    if self.record is not None:
      ...
      for kiter346,viter347 in list(self.record.items()):
    ...
    if self.amounts is not None:
      ...
      for kiter348,viter349 in list(self.amounts.items()):
...
class MutationLogEntry(object):
  ...
  def write(self, oprot):
    ...
    if self.record is not None:
      oprot.writeFieldBegin('record', TType.MAP, 1)
      oprot.writeMapBegin(TType.STRING, TType.STRUCT, len(self.record))
      for kiter364,viter365 in list(self.record.items()):
    ...
    if self.amounts is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.STRUCT, len(self.amounts))
      for kiter366,viter367 in list(self.amounts.items()):
...
class RecordImage(object):
  ...
  def write(self, oprot):
    ...
    if self.record is not None:
      oprot.writeFieldBegin('record', TType.MAP, 1)
      oprot.writeMapBegin(TType.STRING, TType.STRUCT, len(self.record))
      for kiter375,viter376 in list(self.record.items()):
